...
import '../components/sea_food_controller.dart';
import '../models/sea_model.dart';

class SeafoodRestaurantScreen extends StatelessWidget {
  SeafoodRestaurantScreen({Key? key}) : super(key: key);

  final SeafoodRestaurantController controller = Get.put(SeafoodRestaurantController());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.restaurantList.isEmpty) {
          return const Center(child: Text('No seafood restaurants available.'));
        }
  ...
  Widget _buildRestaurantCard(BuildContext context, SeafoodRestaurantModel restaurant) {
    return Card(
      elevation: 4,
